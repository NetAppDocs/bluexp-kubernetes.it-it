...
* link:https://docs.netapp.com/us-en/cloud-manager-setup-admin/task-creating-connectors-azure.html#overview["Creare un connettore da BlueXP"^] (consigliato)
* link:https://docs.netapp.com/us-en/cloud-manager-setup-admin/task-launching-azure-mktp.html["Creare un connettore da Azure Marketplace"^]
