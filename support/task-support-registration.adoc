...
+
image:https://raw.githubusercontent.com/NetAppDocs/bluexp-family/main/media/screenshot-register-support.png["Una schermata che mostra il numero di serie di un account e l'opzione Registra per il supporto"]
